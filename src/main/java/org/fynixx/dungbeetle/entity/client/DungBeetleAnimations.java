...
public class DungBeetleAnimations {
    public static final AnimationDefinition ANIM_DUNG_BEETLE_IDLE = AnimationDefinition.Builder.withLength(4.0F).looping()
            .addAnimation("Beetle", new AnimationChannel(AnimationChannel.Targets.ROTATION,
    ...
    public static final AnimationDefinition ANIM_DUNG_BEETLE_WALK = AnimationDefinition.Builder.withLength(2.0F).looping()
            .addAnimation("Dung", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
